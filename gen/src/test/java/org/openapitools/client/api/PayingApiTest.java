...
public class PayingApiTest {
    ...
    public void createDelayPenaltyChangeTest() throws ApiException {
        ...
        DelayPenalty response = api.createDelayPenaltyChange(createDelayPenaltyChange);
    ...
    public void createStudentFeesTest() throws ApiException {
        ...
        List<Fee> response = api.createStudentFees(studentId, createFee);
    ...
    public void createStudentPaymentsTest() throws ApiException {
        ...
        List<Payment> response = api.createStudentPayments(studentId, feeId, createPayment);
    ...
    public void getDelayPenaltyTest() throws ApiException {
        DelayPenalty response = api.getDelayPenalty();
    ...
    public void getFeesTest() throws ApiException {
        ...
        List<Fee> response = api.getFees(status, page, pageSize);
    ...
    public void getStudentFeeByIdTest() throws ApiException {
        String studentId = null;
        String feeId = null;
        Fee response = api.getStudentFeeById(studentId, feeId);
    ...
    public void getStudentFeesTest() throws ApiException {
        ...
        Integer pageSize = null;
        String status = null;
        List<Fee> response = api.getStudentFees(studentId, page, pageSize, status);
    ...
    public void getStudentPaymentsTest() throws ApiException {
        ...
        Integer page = null;
        Integer pageSize = null;
        List<Payment> response = api.getStudentPayments(studentId, feeId, page, pageSize);

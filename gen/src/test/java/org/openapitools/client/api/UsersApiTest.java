...
public class UsersApiTest {
    ...
    public void createOrUpdateStudentsTest() throws ApiException {
        ...
        List<Student> response = api.createOrUpdateStudents(student);
    ...
    public void createOrUpdateTeachersTest() throws ApiException {
        ...
        List<Teacher> response = api.createOrUpdateTeachers(teacher);
    ...
    public void getManagerByIdTest() throws ApiException {
        String id = null;
        Manager response = api.getManagerById(id);
    ...
    public void getManagersTest() throws ApiException {
        ...
        List<Manager> response = api.getManagers(page, pageSize);
    ...
    public void getStudentsTest() throws ApiException {
        ...
        List<Student> response = api.getStudents(page, pageSize, ref, firstName, lastName);
    ...
    public void getTeacherByIdTest() throws ApiException {
        String id = null;
        Teacher response = api.getTeacherById(id);
    ...
    public void getTeachersTest() throws ApiException {
        ...
        String firstName = null;
        String lastName = null;
        List<Teacher> response = api.getTeachers(page, pageSize, ref, firstName, lastName);
